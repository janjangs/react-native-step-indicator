  ...
  renderStepIndicator = () => {
    ...
    renderStepLabels = () => {
      ...
      var labelViews = labels.map((label,index) => {
        ...
        const fontFamily = this.state.customStyles.labelFamily != '' ? 'fontFamily: this.state.customStyles.labelFamily' : ''
        return (
          <TouchableWithoutFeedback style={styles.stepLabelItem} key={index} onPress={() => this.stepPressed(index)}>
            <View style={styles.stepLabelItem}>
            { 
              ( this.state.customStyles.labelFamily != '') &&
              <Text style={[styles.stepLabel,selectedStepLabelStyle , { fontSize: this.state.customStyles.labelSize, fontFamily: this.state.customStyles.labelFamily }]}>
              {label}
              </Text>
            }
            { 
